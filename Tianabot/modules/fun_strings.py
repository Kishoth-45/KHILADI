...
KHILADI = [
    ...
    "BAACAgUAAx0CRQzCwQACFmxhK13NgmZK3RxKVuub04QuYIDRTAACJQMAAhw0UFWoyaK5tPIVpCAE",
    "https://telegra.ph/file/62c0415d3589b5c6c1c6a.mp4",
]

AUDIO = [
    "CQACAgUAAx0CRQzCwQACFoNhK14v9aUd_j-CSAf8m-_ZzVPj2QACagQAAppKUFWNxCLyeR1NpyAE",
]
...
PAT_GIFS = (
    "CgACAgUAAx0CRQzCwQACFQNhJeVZUDrhfeYNuPXx7vOAMTkyWgACcgMAAj-mEFQDKnYiZhq9wCAE",
    "CgACAgUAAx0CRQzCwQACFQJhJeVTIMH_9dBTsA4Z2UwiQvkgMAACdwMAAj-mEFTGlK6BS9ZJVyAE",
)

PAT_STICKERS = (
    "CAACAgUAAxkBAAIr3GEkWDuAwC4YENWtegTEstQH5Na0AAJhAgACPQlIVg4X3ypYZvumIAQ",
    "CAACAgUAAxkBAAIr3mEkWD2D8r-gbG6Z7Hmm9e5-Kq75AAJiAwACpb1QVhsJR5CJFr0NIAQ",
)
